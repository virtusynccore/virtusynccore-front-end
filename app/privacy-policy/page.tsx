export const metadata = {
  title: 'Privacy Policy — Crivity Visual Design',
  description: 'Read the privacy policy for Crivity Visual Design.',
};
        ...
        <section className="space-y-6 text-sm md:text-base leading-relaxed text-white/80">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to Crivity Visual Design, 404 S Figueroa St, Suite 1210, Los Angeles, CA 90012, USA.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to Crivity Visual Design, accessible from{' '}
                <a
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                <p className="mt-1">Type: Session Cookies<br />Administered by: Us<br />Purpose: These Cookies are essential to provide You with services available through the Website and to enable You to use some of its features. They help to authenticate users and prevent fraudulent use of user accounts. Without these Cookies, the services that You have asked for cannot be provided, and We only use these Cookies to provide You with those services.</p>
              </li>
              <li>
                <strong>Cookies Policy / Notice Acceptance Cookies</strong>
                <p className="mt-1">Type: Persistent Cookies<br />Administered by: Us<br />Purpose: These Cookies identify if users have accepted the use of cookies on the Website.</p>
              </li>
              <li>
                <strong>Functionality Cookies</strong>
                <p className="mt-1">Type: Persistent Cookies<br />Administered by: Us<br />Purpose: These Cookies allow Us to remember choices You make when You use the Website, such as remembering your login details or language preference. The purpose of these Cookies is to provide You with a more personal experience and to avoid You having to re-enter your preferences every time you use the Website.</p>
              </li>
            </ul>
            <p>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>
                ...
                <p className="mt-1">User Accounts: retained for the duration of your account relationship plus up to 24 months after account closure to handle any post-termination issues or resolve disputes.</p>
              </li>
              <li>
                <strong>Customer Support Data</strong>
                <p className="mt-1">Support tickets and correspondence: up to 24 months from the date of ticket closure to resolve follow-up inquiries, track service quality, and defend against potential legal claims<br />Chat transcripts: up to 24 months for quality assurance and staff training purposes.</p>
              </li>
              <li>
                <strong>Usage Data</strong>
                <p className="mt-1">Website analytics data (cookies, IP addresses, device identifiers): up to 24 months from the date of collection, which allows us to analyze trends while respecting privacy principles.<br />Server logs (IP addresses, access times): up to 24 months for security monitoring and troubleshooting purposes.</p>
              </li>
            </ul>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-semibold">Usage, Performance and Miscellaneous</h3>
            <p>We may use third-party Service Providers to maintain and improve our Service.</p>
            <ul className="list-disc list-inside space-y-2">
              <li>
                <strong>Mouseflow</strong>
                <p className="mt-1">Mouseflow is a session replay and heatmap tool that shows how visitors click, move, scroll, browse, and pay attention on websites. The service is operated by ApS.</p>
                <p>The information gathered by Mouseflow is held in accordance with its Privacy Policy: <a href="https://mouseflow.com/privacy/" rel="external nofollow noopener" target="_blank" className="text-cyan-300 hover:text-cyan-200">https://mouseflow.com/privacy/</a></p>
              </li>
              <li>
                <strong>Google Places</strong>
                <p className="mt-1">Google Places is a service that returns information about places using HTTP requests. It is operated by Google.</p>
                <p>Google Places service may collect information from You and from Your Device for security purposes.</p>
                <p>The information gathered by Google Places is held in accordance with the Privacy Policy of Google: <a href="https://www.google.com/intl/en/policies/privacy/" rel="external nofollow noopener" target="_blank" className="text-cyan-300 hover:text-cyan-200">https://www.google.com/intl/en/policies/privacy/</a></p>
              </li>
            </ul>
          </div>
