export const metadata = {
  title: 'Terms and Conditions — Crivity Visual Design',
  description: 'Read the terms and conditions for Crivity Visual Design.',
};

export default function TermsOfServicePage() {
  return (
    <main className="min-h-screen bg-background text-white px-6 py-12 md:px-12 lg:px-24">
      <div className="max-w-4xl mx-auto space-y-8">
        <div>
          <h1 className="text-4xl md:text-5xl font-black mb-3">Terms and Conditions</h1>
          <p className="text-sm text-white/50">Last updated: May 21, 2026</p>
        </div>

        <section className="space-y-6 text-sm md:text-base leading-relaxed text-white/80">
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              ...
              <li>
                <strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to VirtuSync Digital Labs, Los Angeles, 404 S Figueroa St, Suite 1210, Los Angeles, CA 90012, USA.
              </li>
              <li>
              ...
              <li>
                <strong>Website</strong> refers to VirtuSync Digital Labs, accessible from{' '}
                <a
                  href="https://virtusynccore.com/"
                  rel="external nofollow noopener"
                  target="_blank"
                  className="text-cyan-300 hover:text-cyan-200"
                >
                  https://virtusynccore.com/
                </a>
                .
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <h3 className="text-xl font-semibold">Links from a Third-Party Social Media Service</h3>
            <p>
          ...
          <div className="space-y-4">
            ...
            <ul className="list-disc list-inside space-y-2">
              <li>By email: <span className="font-semibold text-white">help@virtusynccore.com</span></li>
              <li>By visiting this page on our website: <a href="https://virtusynccore.com/" rel="external nofollow noopener" target="_blank" className="text-cyan-300 hover:text-cyan-200">https://virtusynccore.com/</a></li>
              <li>By phone: <span className="font-semibold text-white">+1 364-444-5907</span></li>
              <li>By mail: <span className="font-semibold text-white">404 S Figueroa St, Suite 1210, Los Angeles, CA 90012, USA</span></li>
            </ul>
          </div>
        </section>
      </div>
